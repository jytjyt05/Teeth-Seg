...
This project was originally created by 3 CS students from Boston College: Yuting Ji, Robert Smithers, and Danilla Zunic. It originally used a Unet for the model but had accuracy less than 80%. The reason could be the jump between upsampling layers and downsampling layers. As the main developer, to improve the project's performance, I modified the project by using Res-Unet and achieved 90% accuracy.
